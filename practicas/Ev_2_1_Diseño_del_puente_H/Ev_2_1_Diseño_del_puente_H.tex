...
El puente H, es una herramienta muy utlizada desde ya hace tiempo, puesto que en ella podemos ver desde una vista mas basica, el giro de un motor, en sus dos polaridades, cada una de ellas funcionadas en un torque, el cual nos ayuda a ver como podria trabajar la potencia entre las comunicaciones de este, y sus relaciones entre otras razones mas por las cuales, son necesarias tener en cuenta, si es que se quiere trabajar a fururo, con motores, como en el caso de brazos mecanicos, o en cuestion de otros rangos a los que pueda ser utilizado, esto dada a su necesidad que se tiene, y con que frecuencia se tiene en constancia el giro de un motor, ya sea en un proyecto profesional, hasta cualquier hrramienta en la cual se pueda adaptar.\\

Para asi pues, tener en cuenta con que trabajar, y como generar y trasmitir la potencia, corriente y voltaje que se esta relacionando al motor, y como este en caso de los componentes en este caso los MOSFETS, nos son de mucha ayuda a la hora de poder generarlo en otros campos y con que exacitud se tiene, estos cambios de potencia y de corriente, entre polos.
